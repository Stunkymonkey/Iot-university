...
# database.upsert("sensor", "iot/sensors/section1/shelf", "12")
# time.sleep(1)
# database.increment("sensor", "iot/sensors/section1/shelf")
# time.sleep(1)
# database.increment("sensor", "iot/sensors/section1/shelf")
# time.sleep(1)
# database.decrement("sensor", "iot/sensors/section1/shelf")
# print(database.get("sensor", "iot/sensors/section1/shelf"))
